      ...
      body: RefreshIndicator(
        ...
        child: NestedScrollView(
          ...
          body: TabBarView(
            ...
            children: [_buildPostsTab(feedState), _buildToastsTab(feedState)],
          ),
        ),
      ),
    );
              ...
              return Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    if (hasLocation && hasRole) const SizedBox(width: 20),
                    if (hasLocation)
                      Row(
    ...
    return Container(
      ...
      child: TabBar(
        ...
        indicator: UnderlineTabIndicator(
          borderSide: BorderSide(width: 1.5, color: Colors.blue[400]!),
    ...
    if (feedState.posts.isEmpty && !feedState.isLoadingPosts) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            const Icon(Icons.view_array_outlined, size: 64, color: Colors.grey),
        ...
        slivers: [
          ...
          SliverGrid(
            ...
            delegate: SliverChildBuilderDelegate((context, index) {
              ...
              return PostProfileCard(post: post, onTap: () => onPostTap(post));
